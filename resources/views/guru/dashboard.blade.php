                    ...
                    <div class="timeline-simple">
                        @forelse($recentActivities as $activity)
                            <div class="timeline-item d-flex gap-3 mb-4">
                                ...
                                @endphp
                                <div class="aspek-icon-box aspect-icon-{{ $slug }} flex-shrink-0" 
                                ...
                                <div class="timeline-content border-bottom pb-3 w-100">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mt-1">
                                        @if($activity->skor && isset($skorLabels[$activity->skor]))
                                            <span class="badge rounded-pill px-2 py-0" style="font-size: 0.6rem; background-color: {{ $skorLabels[$activity->skor]['color'] }}20; color: {{ $skorLabels[$activity->skor]['color'] }}; border: 1px solid {{ $skorLabels[$activity->skor]['color'] }}40;">
