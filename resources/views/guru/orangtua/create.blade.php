...
<div class="row mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="fw-bold mb-0 text-dark">Tambah Akun Orang Tua</h4>
            <p class="text-muted small">Buat akun login baru untuk wali murid.</p>
        </div>
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm" style="border-radius: 20px;">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('guru.orangtua.store') }}">
                    @csrf
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold text-dark small">Password Akun</label>
                        <div class="input-group">
                        ...
                        <div class="form-text small text-muted mt-1">Berikan password ini kepada orang tua untuk login.</div>
                    </div>
