                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div class="progress" style="height: 5px; border-radius: 10px; background: rgba(0,0,0,0.05);">
                                                        <div class="progress-bar" role="progressbar" style="{{ $percentWidthStyle }}; background-color: {{ $stat->styles['text'] ?? '' }};"></div>
                                                    </div>
                                                </div>

                                                <div class="d-flex align-items-center justify-content-between">
                                                    <span class="badge rounded-pill" style="font-size: 0.6rem; background-color: {{ $stat->status_color }}20; color: {{ $stat->status_color }}; border: 1px solid {{ $stat->status_color }}40;">
                                                        {{ $stat->status }}
                                                    </span>
